...
export default function MonthSelectionHeader({
  filteronPress,
}: {
  filteronPress?: () => void;
}) {
      ...
      <View style={{ flex: 1 }}>
        <TouchableOpacity
          ...
          style={{
            ...
            borderColor: styleConst.COLOR.LIGHT.LIGHT_20,
            flexDirection: "row",
      ...
      >
        <Pressable
          ...
          style={{
            ...
            paddingTop: responsiveHeight(75),
          }}
        >
          <View
            style={{
              ...
              return (
                <Text
                  ...
                  style={{
                    ...
                    fontFamily: styleConst.FONT_FAMILY.INTER_SEMIBOLD,
                    color: styleConst.COLOR.VIOLET.VIOLET_100,
                    borderBottomColor: styleConst.COLOR.GREY.GREY_20,
